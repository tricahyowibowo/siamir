        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <div class="container">
              ...
              <div class="row">
                <div class="col-md-12">
                  <form class="form-horizontal" action="<?=base_url('kategori/simpan')?>" role="form" method="post">
                    <div class="box-body">
                      ...
                      <div class="form-group">
                          <label for="tgl_transaksi" class="col-sm-4 control-label" >Normal Balance :</label>
                            <div class="col-sm-3">
                            <input type="text" name="normal_balance" id="normal_balance" class="form-control">
                            </div>
                      </div>
