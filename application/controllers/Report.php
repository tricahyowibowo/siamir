  ...
  public function barangKeluar(){
    ...
    $html=
      '<div> 
        ...
        <h3 align="center">Invoice Bukti Pengeluaran Barang</h3><br>

        <p>No Id Transaksi  : '.$id.'<span align="right"></span></p>
        <p>Ditunjukan Untuk :</p>
        ...
        <table border="0">
        <tr>
          <th style="width:40px" align="left">No</th>
          <th style="width:120px" align="left">ID Transaksi</th>
          <th style="width:120px" align="left">Tanggal Masuk</th>
        </tr>
        <br>
